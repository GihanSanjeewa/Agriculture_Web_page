        ...
        <div class="container courses_container">
            ...
            <article class="courses">
                <div class="courses_image">
                    <img src="OIP.jpg" style=" height:250px;"/>
                </div>
            ...
            <article class="courses">
                <div class="courses_image">
                    <img src="micronutrient-fertilizers-500x500.jpg" style=" height:250px;" />
                </div>
                <div class="course_info">

                    <h4>Micronutrient fertilizers</h4>

                    <a href="payment.html" class="btn btn-primary">Buy</a>
                </div>
            </article>

            <article class="courses">
                <div class="courses_image">
                    <img src="OIP (1).jpg" style=" height:250px;" />
                </div>
                <div class="course_info">

                    <h4>Nitrogen fertilizers with inhibitors</h4>
            ...
            <article class="courses">
                <div class="courses_image">
                    <img src="OIP (2).jpg" style=" height:250px;"/>
                </div>
                <div class="course_info">

                    <h4>sulphur Fertilizers</h4>
            ...
            <article class="courses">
                <div class="courses_image">
                    <img src="R.jpg" style=" height:250px;" />
                </div>
                <div class="course_info">

                    <h4>Potassium fertilizers</h4>
            ...
            <article class="courses">
                <div class="courses_image">
                    <img src="R (1).jpg" style=" height:250px;"/>
                </div>
                <div class="course_info">

                    <h4>Phosphorus fertilizers</h4>
